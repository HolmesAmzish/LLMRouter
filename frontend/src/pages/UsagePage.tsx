...
const emptyFilter = { from: '', to: '', provider: '', model: '', sessionId: '', apiKeyId: '', requestId: '' }
            ...
            <tbody className="divide-y divide-border">
              {result.content.map((record) => (
                <tr key={record.id} className="text-xs">
                  ...
                  <td className="px-4 py-2">{record.publicModel ?? record.model}</td>
                  <td className="px-4 py-2">{record.upstreamModel ?? record.model}</td>
