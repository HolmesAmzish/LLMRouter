...
class GatewayService(
    ...
    private fun selectAccount(protocol: Protocol): ProviderAccountEntity {
    ...
    private fun upstreamUrl(account: ProviderAccountEntity, model: String): String = when (account.protocol) {
    ...
    private fun headers(account: ProviderAccountEntity): Map<String, String> = when (account.protocol) {
