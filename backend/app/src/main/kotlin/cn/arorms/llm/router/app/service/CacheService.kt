...
import cn.arorms.llm.router.app.entity.CacheEntryEntity
import cn.arorms.llm.router.app.repository.CacheEntryRepository
...
class CacheService(
    ...
    fun put(fingerprint: String, responseJson: String, sessionId: String?, protocol: Protocol, model: String) {
        ...
        repository.save(CacheEntryEntity(fingerprint, sessionId, protocol, model, responseJson, 0, OffsetDateTime.now().plusSeconds(ttlSeconds)))
    }
